...
class CarNavigationNode(Node): 
    ...
    def setup_initial_pose(self): 
        ...
        initial_pose.pose.pose.position.x = 3813.245 
        initial_pose.pose.pose.position.y = 73767.593 
        initial_pose.pose.pose.orientation.z = -0.97 
        initial_pose.pose.pose.orientation.w = 0.240 
        time.sleep(10)
        self.initial_pose_publisher.publish(initial_pose) 
        
    def setup_goals(self): 
        self.goal_poses = [ 
        {'x': 3773.22, 'y': 73731.25, 'xx': 0.0, 'yy': 0.0, 'zz': -0.52, 'w': 0.85}, 
        {'x': 3796.53, 'y': 73712.42, 'xx': 0.0, 'yy': 0.0, 'zz': 0.22, 'w': 0.97},
        {'x': 3857.19, 'y': 73743.96, 'xx': 0.0, 'yy': 0.0, 'zz': 0.22, 'w': 0.97} 
        ]
        time.sleep(5) 
        self.publish_goal() 
